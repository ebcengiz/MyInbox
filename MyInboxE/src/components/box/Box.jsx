...
const Box = () => {
  return (
    <div className="box">
      ...
      <ChatBox img={Avatar2} nameSurname="Frank  Johnson" description="How was the trip?" date="5 days ago" isPassed={true} isPassedBrd={true} />
      <ChatBox img={Avatar3} nameSurname="Ashley Pierce" description="I hope you are well." date="Mar 3, 2022" />
      <ChatBox img={Avatar4} nameSurname="Nancy Meyer" description="Thank you for answering." date="Feb 3, 2022" isPassedK={true} />
    </div>
  )
}
